...
const ProfilePage: React.FC = () => {
    ...
    // Global State
    const { profile, skills, badges } = useUserStore();
     ...
     return (
         <div className="relative flex h-full min-h-screen w-full flex-col bg-background-light dark:bg-background-dark shadow-xl overflow-hidden pb-24">
            ...
            <main className="flex-1 flex flex-col px-4 gap-6 overflow-y-auto hide-scrollbar">
                <div className="relative flex flex-col items-center pt-6 pb-8 px-6 bg-white dark:bg-[#1e293b] rounded-[2rem] shadow-sm">
                    <button 
                    ...
                    <div className="relative mb-4 group cursor-pointer">
                        <div className="bg-center bg-no-repeat bg-cover rounded-full size-28 border-4 border-slate-50 dark:border-slate-700 shadow-md group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: `url("${profile.avatar}")`}}></div>
                        <div className="absolute bottom-1 right-1 size-5 bg-green-500 rounded-full border-4 border-white dark:border-[#1e293b]"></div>
                    </div>
                    <h2 className="text-slate-900 dark:text-white text-2xl font-bold leading-tight mb-1 text-center">{profile.name}</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mb-5 text-center">{profile.role}</p>
                ...
                <div className="bg-white dark:bg-[#1e293b] rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col gap-4 animate-fadeIn">
                    <div>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-medium text-slate-600 dark:text-slate-300">{profile.email}</span>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-medium text-slate-600 dark:text-slate-300">{profile.phone}</span>
                        </div>
                         <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-medium text-[#0077b5] hover:underline cursor-pointer">{profile.linkedin}</span>
                        </div>
                    </div>
                </div>
                 ...
                 <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-white dark:bg-[#1e293b] p-5 rounded-[2rem] shadow-sm flex flex-col justify-between h-32 relative overflow-hidden group">
                            ...
                            <div className="z-10">
                                <p className="text-3xl font-extrabold text-slate-900 dark:text-white mb-1">{profile.xp}</p>
